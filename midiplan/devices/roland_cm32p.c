...
const midiplan_device_t roland_cm32p = {
    ...
    .max_notes_per_channel_group = { 0, 0, 0, 16 }, // 31 partials, no instrument uses more than 2 partials
    ...
    .melodic_programs = {
        ...
        /* 0x14  21  GM_PROGRAM_REED_ORGAN            */ {  .program = ROLAND_CM32P_SAX_2,       .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x15  22  GM_PROGRAM_ACCORDION             */ {  .program = ROLAND_CM32P_TP_TRB_2,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x16  23  GM_PROGRAM_HARMONICA             */ {  .program = ROLAND_CM32P_TP_TRB_2,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x17  24  GM_PROGRAM_TANGO_ACCORDION       */ {  .program = ROLAND_CM32P_TP_TRB_2,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x18  25  GM_PROGRAM_ACOUSTIC_GUITAR_NYLON */ {  .program = ROLAND_CM32P_A_GUITAR_3,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x19  26  GM_PROGRAM_ACOUSTIC_GUITAR_STEEL */ {  .program = ROLAND_CM32P_A_GUITAR_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x1A  27  GM_PROGRAM_ELECTRIC_GUITAR_JAZZ  */ {  .program = ROLAND_CM32P_A_GUITAR_3,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x1B  28  GM_PROGRAM_ELECTRIC_GUITAR_CLEAN */ {  .program = ROLAND_CM32P_E_GUITAR_2,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x1C  29  GM_PROGRAM_ELECTRIC_GUITAR_MUTED */ {  .program = ROLAND_CM32P_E_GUITAR_2,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x1D  30  GM_PROGRAM_OVERDRIVEN_GUITAR     */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT | VOLUME_UP_6DB  },
        /* 0x1E  31  GM_PROGRAM_DISTORTION_GUITAR     */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT | VOLUME_UP_6DB  },
        /* 0x1F  32  GM_PROGRAM_GUITAR_HARMONICS      */ {  .program = ROLAND_CM32P_FINGERED_1,  .flags = ROLAND_CM32P_RANGE_OCTAVE_HIGHER            },
        /* 0x20  33  GM_PROGRAM_ACOUSTIC_BASS         */ {  .program = ROLAND_CM32P_AC_BASS,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x21  34  GM_PROGRAM_ELECTRIC_BASS_FINGER  */ {  .program = ROLAND_CM32P_FINGERED_1,  .flags = ROLAND_CM32P_RANGE_PROG_73                  },
        /* 0x22  35  GM_PROGRAM_ELECTRIC_BASS_PICK    */ {  .program = ROLAND_CM32P_PICKED_2,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x23  36  GM_PROGRAM_FRETLESS_BASS         */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_PROG_87                  },
        /* 0x24  37  GM_PROGRAM_SLAP_BASS_1           */ {  .program = ROLAND_CM32P_SLAP_4,      .flags = ROLAND_CM32P_RANGE_PROG_66                  },
        /* 0x25  38  GM_PROGRAM_SLAP_BASS_2           */ {  .program = ROLAND_CM32P_SLAP_3,      .flags = ROLAND_CM32P_RANGE_PROG_66                  },
        /* 0x26  39  GM_PROGRAM_SYNTH_BASS_1          */ {  .program = ROLAND_CM32P_FINGERED_2,  .flags = ROLAND_CM32P_RANGE_PROG_73                  },
        /* 0x27  40  GM_PROGRAM_SYNTH_BASS_2          */ {  .program = ROLAND_CM32P_FINGERED_2,  .flags = ROLAND_CM32P_RANGE_PROG_73                  },
        ...
        /* 0x2F  48  GM_PROGRAM_TIMPANI               */ {  .program = ROLAND_CM32P_E_PIANO_5,   .flags = ROLAND_CM32P_RANGE_OCTAVE_LOWER             },
        /* 0x30  49  GM_PROGRAM_STRING_ENSEMBLE_1     */ {  .program = ROLAND_CM32P_STRINGS_2,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x31  50  GM_PROGRAM_STRING_ENSEMBLE_2     */ {  .program = ROLAND_CM32P_STRINGS_1,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x32  51  GM_PROGRAM_SYNTHSTRINGS_1        */ {  .program = ROLAND_CM32P_STRINGS_3,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x33  52  GM_PROGRAM_SYNTHSTRINGS_2        */ {  .program = ROLAND_CM32P_STRINGS_4,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x34  53  GM_PROGRAM_CHOIR_AAHS            */ {  .program = ROLAND_CM32P_CHOIR_2,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x35  54  GM_PROGRAM_VOICE_OOHS            */ {  .program = ROLAND_CM32P_CHOIR_1,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x36  55  GM_PROGRAM_SYNTH_VOICE           */ {  .program = ROLAND_CM32P_CHOIR_3,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x37  56  GM_PROGRAM_ORCHESTRA_HIT         */ {  .program = ROLAND_CM32P_ORCHE_HIT,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x38  57  GM_PROGRAM_TRUMPET               */ {  .program = ROLAND_CM32P_SOFT_TP_1,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x39  58  GM_PROGRAM_TROMBONE              */ {  .program = ROLAND_CM32P_TP_TRB_2,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x3A  59  GM_PROGRAM_TUBA                  */ {  .program = ROLAND_CM32P_SOFT_TP_1,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x3B  60  GM_PROGRAM_MUTED_TRUMPET         */ {  .program = ROLAND_CM32P_TP_TRB_1,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x3C  61  GM_PROGRAM_FRENCH_HORN           */ {  .program = ROLAND_CM32P_SAX_2,       .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        ...
        /* 0x4B  76  GM_PROGRAM_PAN_FLUTE             */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x4C  77  GM_PROGRAM_BLOWN_BOTTLE          */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x4D  78  GM_PROGRAM_SHAKUHACHI            */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x4E  79  GM_PROGRAM_WHISTLE               */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x4F  80  GM_PROGRAM_OCARINA               */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x50  81  GM_PROGRAM_LEAD_1_SQUARE         */ {  .program = ROLAND_CM32P_TP_TRB_2,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x51  82  GM_PROGRAM_LEAD_2_SAWTOOTH       */ {  .program = ROLAND_CM32P_BRASS_4,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x52  83  GM_PROGRAM_LEAD_3_CALLIOPE       */ {  .program = ROLAND_CM32P_STRINGS_2,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x53  84  GM_PROGRAM_LEAD_4_CHIFF          */ {  .program = ROLAND_CM32P_E_PIANO_5,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x54  85  GM_PROGRAM_LEAD_5_CHARANG        */ {  .program = ROLAND_CM32P_TP_TRB_5,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x55  86  GM_PROGRAM_LEAD_6_VOICE          */ {  .program = ROLAND_CM32P_CHOIR_4,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x56  87  GM_PROGRAM_LEAD_7_FIFTHS         */ {  .program = ROLAND_CM32P_STRINGS_2,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x57  88  GM_PROGRAM_LEAD_8_BASS_LEAD      */ {  .program = ROLAND_CM32P_PICKED_2,    .flags = ROLAND_CM32P_RANGE_OCTAVE_HIGHER            },
        /* 0x58  89  GM_PROGRAM_PAD_1_NEW_AGE         */ {  .program = ROLAND_CM32P_E_PIANO_3,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x59  90  GM_PROGRAM_PAD_2_WARM            */ {  .program = ROLAND_CM32P_BRASS_5,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x5A  91  GM_PROGRAM_PAD_3_POLYSYNTH       */ {  .program = ROLAND_CM32P_STRINGS_1,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x5B  92  GM_PROGRAM_PAD_4_CHOIR           */ {  .program = ROLAND_CM32P_CHOIR_3,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x5C  93  GM_PROGRAM_PAD_5_BOWED           */ {  .program = ROLAND_CM32P_E_PIANO_3,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x5D  94  GM_PROGRAM_PAD_6_METALLIC        */ {  .program = ROLAND_CM32P_SLAP_6,      .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x5E  95  GM_PROGRAM_PAD_7_HALO            */ {  .program = ROLAND_CM32P_E_PIANO_5,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x5F  96  GM_PROGRAM_PAD_8_SWEEP           */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x60  97  GM_PROGRAM_FX_1_RAIN             */ {  .program = ROLAND_CM32P_FRETLESS_1,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x61  98  GM_PROGRAM_FX_2_SOUNDTRACK       */ {  .program = ROLAND_CM32P_BRASS_1,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x62  99  GM_PROGRAM_FX_3_CRYSTAL          */ {  .program = ROLAND_CM32P_E_PIANO_3,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x63 100  GM_PROGRAM_FX_4_ATMOSPHERE       */ {  .program = ROLAND_CM32P_FINGERED_2,  .flags = ROLAND_CM32P_RANGE_PROG_73                  },
        /* 0x64 101  GM_PROGRAM_FX_5_BRIGHTNESS       */ {  .program = ROLAND_CM32P_CHOIR_1,     .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x65 102  GM_PROGRAM_FX_6_GOBLINS          */ {  .program = ROLAND_CM32P_SLAP_5,      .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x66 103  GM_PROGRAM_FX_7_ECHOES           */ {  .program = ROLAND_CM32P_PICKED_2,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x67 104  GM_PROGRAM_FX_8_SCI_FI           */ {  .program = ROLAND_CM32P_PICKED_2,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x68 105  GM_PROGRAM_SITAR                 */ {  .program = ROLAND_CM32P_SLAP_10,     .flags = ROLAND_CM32P_RANGE_PROG_61                  },
        /* 0x69 106  GM_PROGRAM_BANJO                 */ {  .program = ROLAND_CM32P_SLAP_4,      .flags = ROLAND_CM32P_RANGE_PROG_66                  },
        /* 0x6A 107  GM_PROGRAM_SHAMISEN              */ {  .program = ROLAND_CM32P_SLAP_10,     .flags = ROLAND_CM32P_RANGE_PROG_61                  },
        /* 0x6B 108  GM_PROGRAM_KOTO                  */ {  .program = ROLAND_CM32P_SLAP_10,     .flags = ROLAND_CM32P_RANGE_PROG_61                  },
        /* 0x6C 109  GM_PROGRAM_KALIMBA               */ {  .program = ROLAND_CM32P_SLAP_5,      .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x6D 110  GM_PROGRAM_BAG_PIPE              */ {  .program = ROLAND_CM32P_TP_TRB_3,    .flags = ROLAND_CM32P_RANGE_OCTAVE_LOWER             },
        /* 0x6E 111  GM_PROGRAM_FIDDLE                */ {  .program = ROLAND_CM32P_STRINGS_2,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x6F 112  GM_PROGRAM_SHANAI                */ {  .program = ROLAND_CM32P_TP_TRB_5,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x70 113  GM_PROGRAM_TINKLE_BELL           */ {  .program = ROLAND_CM32P_E_PIANO_5,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x71 114  GM_PROGRAM_AGOGO                 */ {  .program = ROLAND_CM32P_E_GUITAR_2,  .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x72 115  GM_PROGRAM_STEEL_DRUMS           */ {  .program = ROLAND_CM32P_E_ORGAN_6,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x73 116  GM_PROGRAM_WOODBLOCK             */ {  .program = ROLAND_CM32P_E_ORGAN_6,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x74 117  GM_PROGRAM_TAIKO_DRUM            */ {  .program = ROLAND_CM32P_E_ORGAN_6,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x75 118  GM_PROGRAM_MELODIC_TOM           */ {  .program = ROLAND_CM32P_E_ORGAN_6,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x76 119  GM_PROGRAM_SYNTH_DRUM            */ {  .program = ROLAND_CM32P_E_ORGAN_6,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x77 120  GM_PROGRAM_REVERSE_CYMBAL        */ {  .program = ROLAND_CM32P_TP_TRB_3,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x78 121  GM_PROGRAM_GUITAR_FRET_NOISE     */ {  .program = ROLAND_CM32P_SLAP_3,      .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x79 122  GM_PROGRAM_BREATH_NOISE          */ {  .program = ROLAND_CM32P_SOFT_TP_3,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x7A 123  GM_PROGRAM_SEASHORE              */ {  .program = ROLAND_CM32P_TP_TRB_5,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x7B 124  GM_PROGRAM_BIRD_TWEET            */ {  .program = ROLAND_CM32P_E_ORGAN_6,   .flags = ROLAND_CM32P_RANGE_OCTAVE_HIGHER            },
        /* 0x7C 125  GM_PROGRAM_TELEPHONE_RING        */ {  .program = ROLAND_CM32P_SLAP_3,      .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x7D 126  GM_PROGRAM_HELICOPTER            */ {  .program = ROLAND_CM32P_SLAP_10,     .flags = ROLAND_CM32P_RANGE_PROG_61                  },
        /* 0x7E 127  GM_PROGRAM_APPLAUSE              */ {  .program = ROLAND_CM32P_TP_TRB_5,    .flags = ROLAND_CM32P_RANGE_DEFAULT                  },
        /* 0x7F 128  GM_PROGRAM_GUNSHOT               */ {  .program = ROLAND_CM32P_E_ORGAN_6,   .flags = ROLAND_CM32P_RANGE_DEFAULT                  }
    },
