...
const midiplan_device_t null_device = {
    ...
    .melodic_programs = {
        ...
        /* 0x01   2  GM_PROGRAM_BRIGHT_ACOUSTIC_PIANO */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x02   3  GM_PROGRAM_ELECTRIC_GRAND_PIANO  */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x03   4  GM_PROGRAM_HONKY_TONK_PIANO      */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x04   5  GM_PROGRAM_ELECTRIC_PIANO_1      */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x05   6  GM_PROGRAM_ELECTRIC_PIANO_2      */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x06   7  GM_PROGRAM_HARPSICHORD           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x07   8  GM_PROGRAM_CLAVI                 */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x08   9  GM_PROGRAM_CELESTA               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x09  10  GM_PROGRAM_GLOCKENSPIEL          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x0A  11  GM_PROGRAM_MUSIC_BOX             */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x0B  12  GM_PROGRAM_VIBRAPHONE            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x0C  13  GM_PROGRAM_MARIMBA               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x0D  14  GM_PROGRAM_XYLOPHONE             */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x0E  15  GM_PROGRAM_TUBULAR_BELLS         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x0F  16  GM_PROGRAM_DULCIMER              */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x10  17  GM_PROGRAM_DRAWBAR_ORGAN         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x11  18  GM_PROGRAM_PERCUSSIVE_ORGAN      */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x12  19  GM_PROGRAM_ROCK_ORGAN            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x13  20  GM_PROGRAM_CHURCH_ORGAN          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x14  21  GM_PROGRAM_REED_ORGAN            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x15  22  GM_PROGRAM_ACCORDION             */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x16  23  GM_PROGRAM_HARMONICA             */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x17  24  GM_PROGRAM_TANGO_ACCORDION       */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x18  25  GM_PROGRAM_ACOUSTIC_GUITAR_NYLON */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x19  26  GM_PROGRAM_ACOUSTIC_GUITAR_STEEL */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x1A  27  GM_PROGRAM_ELECTRIC_GUITAR_JAZZ  */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x1B  28  GM_PROGRAM_ELECTRIC_GUITAR_CLEAN */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x1C  29  GM_PROGRAM_ELECTRIC_GUITAR_MUTED */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x1D  30  GM_PROGRAM_OVERDRIVEN_GUITAR     */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x1E  31  GM_PROGRAM_DISTORTION_GUITAR     */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x1F  32  GM_PROGRAM_GUITAR_HARMONICS      */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x20  33  GM_PROGRAM_ACOUSTIC_BASS         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x21  34  GM_PROGRAM_ELECTRIC_BASS_FINGER  */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x22  35  GM_PROGRAM_ELECTRIC_BASS_PICK    */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x23  36  GM_PROGRAM_FRETLESS_BASS         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x24  37  GM_PROGRAM_SLAP_BASS_1           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x25  38  GM_PROGRAM_SLAP_BASS_2           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x26  39  GM_PROGRAM_SYNTH_BASS_1          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x27  40  GM_PROGRAM_SYNTH_BASS_2          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x28  41  GM_PROGRAM_VIOLIN                */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x29  42  GM_PROGRAM_VIOLA                 */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x2A  43  GM_PROGRAM_CELLO                 */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x2B  44  GM_PROGRAM_CONTRABASS            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x2C  45  GM_PROGRAM_TREMOLO_STRINGS       */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x2D  46  GM_PROGRAM_PIZZICATO_STRINGS     */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x2E  47  GM_PROGRAM_ORCHESTRAL_HARP       */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x2F  48  GM_PROGRAM_TIMPANI               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x30  49  GM_PROGRAM_STRING_ENSEMBLE_1     */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x31  50  GM_PROGRAM_STRING_ENSEMBLE_2     */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x32  51  GM_PROGRAM_SYNTHSTRINGS_1        */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x33  52  GM_PROGRAM_SYNTHSTRINGS_2        */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x34  53  GM_PROGRAM_CHOIR_AAHS            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x35  54  GM_PROGRAM_VOICE_OOHS            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x36  55  GM_PROGRAM_SYNTH_VOICE           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x37  56  GM_PROGRAM_ORCHESTRA_HIT         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x38  57  GM_PROGRAM_TRUMPET               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x39  58  GM_PROGRAM_TROMBONE              */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x3A  59  GM_PROGRAM_TUBA                  */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x3B  60  GM_PROGRAM_MUTED_TRUMPET         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x3C  61  GM_PROGRAM_FRENCH_HORN           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x3D  62  GM_PROGRAM_BRASS_SECTION         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x3E  63  GM_PROGRAM_SYNTHBRASS_1          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x3F  64  GM_PROGRAM_SYNTHBRASS_2          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x40  65  GM_PROGRAM_SOPRANO_SAX           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x41  66  GM_PROGRAM_ALTO_SAX              */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x42  67  GM_PROGRAM_TENOR_SAX             */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x43  68  GM_PROGRAM_BARITONE_SAX          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x44  69  GM_PROGRAM_OBOE                  */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x45  70  GM_PROGRAM_ENGLISH_HORN          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x46  71  GM_PROGRAM_BASSOON               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x47  72  GM_PROGRAM_CLARINET              */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x48  73  GM_PROGRAM_PICCOLO               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x49  74  GM_PROGRAM_FLUTE                 */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x4A  75  GM_PROGRAM_RECORDER              */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x4B  76  GM_PROGRAM_PAN_FLUTE             */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x4C  77  GM_PROGRAM_BLOWN_BOTTLE          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x4D  78  GM_PROGRAM_SHAKUHACHI            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x4E  79  GM_PROGRAM_WHISTLE               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x4F  80  GM_PROGRAM_OCARINA               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x50  81  GM_PROGRAM_LEAD_1_SQUARE         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x51  82  GM_PROGRAM_LEAD_2_SAWTOOTH       */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x52  83  GM_PROGRAM_LEAD_3_CALLIOPE       */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x53  84  GM_PROGRAM_LEAD_4_CHIFF          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x54  85  GM_PROGRAM_LEAD_5_CHARANG        */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x55  86  GM_PROGRAM_LEAD_6_VOICE          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x56  87  GM_PROGRAM_LEAD_7_FIFTHS         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x57  88  GM_PROGRAM_LEAD_8_BASS_LEAD      */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x58  89  GM_PROGRAM_PAD_1_NEW_AGE         */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x59  90  GM_PROGRAM_PAD_2_WARM            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x5A  91  GM_PROGRAM_PAD_3_POLYSYNTH       */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x5B  92  GM_PROGRAM_PAD_4_CHOIR           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x5C  93  GM_PROGRAM_PAD_5_BOWED           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x5D  94  GM_PROGRAM_PAD_6_METALLIC        */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x5E  95  GM_PROGRAM_PAD_7_HALO            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x5F  96  GM_PROGRAM_PAD_8_SWEEP           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x60  97  GM_PROGRAM_FX_1_RAIN             */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x61  98  GM_PROGRAM_FX_2_SOUNDTRACK       */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x62  99  GM_PROGRAM_FX_3_CRYSTAL          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x63 100  GM_PROGRAM_FX_4_ATMOSPHERE       */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x64 101  GM_PROGRAM_FX_5_BRIGHTNESS       */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x65 102  GM_PROGRAM_FX_6_GOBLINS          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x66 103  GM_PROGRAM_FX_7_ECHOES           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x67 104  GM_PROGRAM_FX_8_SCI_FI           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x68 105  GM_PROGRAM_SITAR                 */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x69 106  GM_PROGRAM_BANJO                 */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x6A 107  GM_PROGRAM_SHAMISEN              */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x6B 108  GM_PROGRAM_KOTO                  */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x6C 109  GM_PROGRAM_KALIMBA               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x6D 110  GM_PROGRAM_BAG_PIPE              */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x6E 111  GM_PROGRAM_FIDDLE                */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x6F 112  GM_PROGRAM_SHANAI                */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x70 113  GM_PROGRAM_TINKLE_BELL           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x71 114  GM_PROGRAM_AGOGO                 */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x72 115  GM_PROGRAM_STEEL_DRUMS           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x73 116  GM_PROGRAM_WOODBLOCK             */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x74 117  GM_PROGRAM_TAIKO_DRUM            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x75 118  GM_PROGRAM_MELODIC_TOM           */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x76 119  GM_PROGRAM_SYNTH_DRUM            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x77 120  GM_PROGRAM_REVERSE_CYMBAL        */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x78 121  GM_PROGRAM_GUITAR_FRET_NOISE     */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x79 122  GM_PROGRAM_BREATH_NOISE          */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x7A 123  GM_PROGRAM_SEASHORE              */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x7B 124  GM_PROGRAM_BIRD_TWEET            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x7C 125  GM_PROGRAM_TELEPHONE_RING        */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x7D 126  GM_PROGRAM_HELICOPTER            */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x7E 127  GM_PROGRAM_APPLAUSE              */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  },
        /* 0x7F 128  GM_PROGRAM_GUNSHOT               */ {  .program = INVALID_PROGRAM,  .flags = NULL_DEVICE_RANGE_INVALID  }
    },

    .melodic_note_ranges = {
        /* 0x00 NULL_DEVICE_RANGE_INVALID */ {  .lowest_note = INVALID_NOTE,  .middle_c = INVALID_NOTE,  .highest_note = INVALID_NOTE  },
