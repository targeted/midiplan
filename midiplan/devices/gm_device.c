...
const midiplan_device_t gm_device = {
    ...
    .model_name = "General MIDI",

    .max_notes_per_channel_group = { 0, 0, 0, MAX_NOTE_ENTRIES },
    ...
    .initialization_sequence = (const uint8_t[]) {
        ...
        /* select bank 1 on all channels */

        0xB0, 0x00, 0x00, 0xB0, 0x20, 0x00,
        0xB1, 0x00, 0x00, 0xB1, 0x20, 0x00,
        0xB2, 0x00, 0x00, 0xB2, 0x20, 0x00,
        0xB3, 0x00, 0x00, 0xB3, 0x20, 0x00,
        0xB4, 0x00, 0x00, 0xB4, 0x20, 0x00,
        0xB5, 0x00, 0x00, 0xB5, 0x20, 0x00,
        0xB6, 0x00, 0x00, 0xB6, 0x20, 0x00,
        0xB7, 0x00, 0x00, 0xB7, 0x20, 0x00,
        0xB8, 0x00, 0x00, 0xB8, 0x20, 0x00,
        0xB9, 0x00, 0x00, 0xB9, 0x20, 0x00, // not clear whether it makes sense to do on channel 10
        0xBA, 0x00, 0x00, 0xBA, 0x20, 0x00,
        0xBB, 0x00, 0x00, 0xBB, 0x20, 0x00,
        0xBC, 0x00, 0x00, 0xBC, 0x20, 0x00,
        0xBD, 0x00, 0x00, 0xBD, 0x20, 0x00,
        0xBE, 0x00, 0x00, 0xBE, 0x20, 0x00,
        0xBF, 0x00, 0x00, 0xBF, 0x20, 0x00,
