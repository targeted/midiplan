...
const midiplan_device_t zoom_rt234 = {
    ...
    .max_notes_per_channel_group = { 0, 0, 0, 32 },
    ...
    .melodic_programs = {
        ...
        /* 0x02   2  GM_PROGRAM_ELECTRIC_GRAND_PIANO  */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x03   3  GM_PROGRAM_HONKY_TONK_PIANO      */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x04   4  GM_PROGRAM_ELECTRIC_PIANO_1      */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x05   5  GM_PROGRAM_ELECTRIC_PIANO_2      */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x06   6  GM_PROGRAM_HARPSICHORD           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x07   7  GM_PROGRAM_CLAVI                 */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x08   8  GM_PROGRAM_CELESTA               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x09   9  GM_PROGRAM_GLOCKENSPIEL          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x0A  10  GM_PROGRAM_MUSIC_BOX             */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x0B  11  GM_PROGRAM_VIBRAPHONE            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x0C  12  GM_PROGRAM_MARIMBA               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x0D  13  GM_PROGRAM_XYLOPHONE             */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x0E  14  GM_PROGRAM_TUBULAR_BELLS         */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x0F  15  GM_PROGRAM_DULCIMER              */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x10  16  GM_PROGRAM_DRAWBAR_ORGAN         */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x11  17  GM_PROGRAM_PERCUSSIVE_ORGAN      */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x12  18  GM_PROGRAM_ROCK_ORGAN            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x13  19  GM_PROGRAM_CHURCH_ORGAN          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x14  20  GM_PROGRAM_REED_ORGAN            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x15  21  GM_PROGRAM_ACCORDION             */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x16  22  GM_PROGRAM_HARMONICA             */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x17  23  GM_PROGRAM_TANGO_ACCORDION       */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x18  24  GM_PROGRAM_ACOUSTIC_GUITAR_NYLON */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x19  25  GM_PROGRAM_ACOUSTIC_GUITAR_STEEL */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x1A  26  GM_PROGRAM_ELECTRIC_GUITAR_JAZZ  */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x1B  27  GM_PROGRAM_ELECTRIC_GUITAR_CLEAN */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x1C  28  GM_PROGRAM_ELECTRIC_GUITAR_MUTED */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        ...
        /* 0x2B  43  GM_PROGRAM_CONTRABASS            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x2C  44  GM_PROGRAM_TREMOLO_STRINGS       */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x2D  45  GM_PROGRAM_PIZZICATO_STRINGS     */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x2E  46  GM_PROGRAM_ORCHESTRAL_HARP       */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x2F  47  GM_PROGRAM_TIMPANI               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x30  48  GM_PROGRAM_STRING_ENSEMBLE_1     */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x31  49  GM_PROGRAM_STRING_ENSEMBLE_2     */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x32  50  GM_PROGRAM_SYNTHSTRINGS_1        */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x33  51  GM_PROGRAM_SYNTHSTRINGS_2        */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x34  52  GM_PROGRAM_CHOIR_AAHS            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x35  53  GM_PROGRAM_VOICE_OOHS            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x36  54  GM_PROGRAM_SYNTH_VOICE           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x37  55  GM_PROGRAM_ORCHESTRA_HIT         */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x38  56  GM_PROGRAM_TRUMPET               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x39  57  GM_PROGRAM_TROMBONE              */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x3A  58  GM_PROGRAM_TUBA                  */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x3B  59  GM_PROGRAM_MUTED_TRUMPET         */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x3C  60  GM_PROGRAM_FRENCH_HORN           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x3D  61  GM_PROGRAM_BRASS_SECTION         */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x3E  62  GM_PROGRAM_SYNTHBRASS_1          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x3F  63  GM_PROGRAM_SYNTHBRASS_2          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x40  64  GM_PROGRAM_SOPRANO_SAX           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x41  65  GM_PROGRAM_ALTO_SAX              */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x42  66  GM_PROGRAM_TENOR_SAX             */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x43  67  GM_PROGRAM_BARITONE_SAX          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x44  68  GM_PROGRAM_OBOE                  */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x45  69  GM_PROGRAM_ENGLISH_HORN          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x46  70  GM_PROGRAM_BASSOON               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x47  71  GM_PROGRAM_CLARINET              */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x48  72  GM_PROGRAM_PICCOLO               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x49  73  GM_PROGRAM_FLUTE                 */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x4A  74  GM_PROGRAM_RECORDER              */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x4B  75  GM_PROGRAM_PAN_FLUTE             */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x4C  76  GM_PROGRAM_BLOWN_BOTTLE          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x4D  77  GM_PROGRAM_SHAKUHACHI            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x4E  78  GM_PROGRAM_WHISTLE               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x4F  79  GM_PROGRAM_OCARINA               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x50  80  GM_PROGRAM_LEAD_1_SQUARE         */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x51  81  GM_PROGRAM_LEAD_2_SAWTOOTH       */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x52  82  GM_PROGRAM_LEAD_3_CALLIOPE       */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x53  83  GM_PROGRAM_LEAD_4_CHIFF          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x54  84  GM_PROGRAM_LEAD_5_CHARANG        */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x55  85  GM_PROGRAM_LEAD_6_VOICE          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x56  86  GM_PROGRAM_LEAD_7_FIFTHS         */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x57  87  GM_PROGRAM_LEAD_8_BASS_LEAD      */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x58  88  GM_PROGRAM_PAD_1_NEW_AGE         */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x59  89  GM_PROGRAM_PAD_2_WARM            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x5A  90  GM_PROGRAM_PAD_3_POLYSYNTH       */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x5B  91  GM_PROGRAM_PAD_4_CHOIR           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x5C  92  GM_PROGRAM_PAD_5_BOWED           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x5D  93  GM_PROGRAM_PAD_6_METALLIC        */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x5E  94  GM_PROGRAM_PAD_7_HALO            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x5F  95  GM_PROGRAM_PAD_8_SWEEP           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x60  96  GM_PROGRAM_FX_1_RAIN             */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x61  97  GM_PROGRAM_FX_2_SOUNDTRACK       */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x62  98  GM_PROGRAM_FX_3_CRYSTAL          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x63  99  GM_PROGRAM_FX_4_ATMOSPHERE       */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x64 100  GM_PROGRAM_FX_5_BRIGHTNESS       */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x65 101  GM_PROGRAM_FX_6_GOBLINS          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x66 102  GM_PROGRAM_FX_7_ECHOES           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x67 103  GM_PROGRAM_FX_8_SCI_FI           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x68 104  GM_PROGRAM_SITAR                 */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x69 105  GM_PROGRAM_BANJO                 */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x6A 106  GM_PROGRAM_SHAMISEN              */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x6B 107  GM_PROGRAM_KOTO                  */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x6C 108  GM_PROGRAM_KALIMBA               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x6D 109  GM_PROGRAM_BAG_PIPE              */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x6E 110  GM_PROGRAM_FIDDLE                */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x6F 111  GM_PROGRAM_SHANAI                */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x70 112  GM_PROGRAM_TINKLE_BELL           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x71 113  GM_PROGRAM_AGOGO                 */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x72 114  GM_PROGRAM_STEEL_DRUMS           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x73 115  GM_PROGRAM_WOODBLOCK             */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x74 116  GM_PROGRAM_TAIKO_DRUM            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x75 117  GM_PROGRAM_MELODIC_TOM           */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x76 118  GM_PROGRAM_SYNTH_DRUM            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x77 119  GM_PROGRAM_REVERSE_CYMBAL        */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x78 120  GM_PROGRAM_GUITAR_FRET_NOISE     */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x79 121  GM_PROGRAM_BREATH_NOISE          */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x7A 122  GM_PROGRAM_SEASHORE              */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x7B 123  GM_PROGRAM_BIRD_TWEET            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x7C 124  GM_PROGRAM_TELEPHONE_RING        */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x7D 125  GM_PROGRAM_HELICOPTER            */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x7E 126  GM_PROGRAM_APPLAUSE              */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  },
        /* 0x7F 127  GM_PROGRAM_GUNSHOT               */ {  .program = INVALID_PROGRAM,                    .flags = ZOOM_RT234_RANGE_INVALID  }
    },

    .melodic_note_ranges = {
        /* 0x00 ZOOM_RT234_RANGE_INVALID */ {  .lowest_note = INVALID_NOTE,            .middle_c = INVALID_NOTE,         .highest_note = INVALID_NOTE             },
    ...
    .percussion_notes = {
        ...
        /* 0x23  35  GM_PERCUSSION_ACOUSTIC_BASS_DRUM */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_ACOUSTIC_BASS_DRUM  },
        /* 0x24  36  GM_PERCUSSION_BASS_DRUM_1        */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_BASS_DRUM_1         },
        /* 0x25  37  GM_PERCUSSION_SIDE_STICK         */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_SIDE_STICK          },
        /* 0x26  38  GM_PERCUSSION_ACOUSTIC_SNARE     */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_ACOUSTIC_SNARE      },
        /* 0x27  39  GM_PERCUSSION_HAND_CLAP          */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_HAND_CLAP           },
        /* 0x28  40  GM_PERCUSSION_ELECTRIC_SNARE     */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_ELECTRIC_SNARE      },
        /* 0x29  41  GM_PERCUSSION_LOW_FLOOR_TOM      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LOW_FLOOR_TOM       },
        /* 0x2A  42  GM_PERCUSSION_CLOSED_HI_HAT      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_CLOSED_HI_HAT       },
        /* 0x2B  43  GM_PERCUSSION_HIGH_FLOOR_TOM     */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_HIGH_FLOOR_TOM      },
        /* 0x2C  44  GM_PERCUSSION_PEDAL_HI_HAT       */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_PEDAL_HI_HAT        },
        /* 0x2D  45  GM_PERCUSSION_LOW_TOM            */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LOW_TOM             },
        /* 0x2E  46  GM_PERCUSSION_OPEN_HI_HAT        */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_OPEN_HI_HAT         },
        /* 0x2F  47  GM_PERCUSSION_LOW_MID_TOM        */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LOW_MID_TOM         },
        /* 0x30  48  GM_PERCUSSION_HI_MID_TOM         */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_HI_MID_TOM          },
        /* 0x31  49  GM_PERCUSSION_CRASH_CYMBAL_1     */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_CRASH_CYMBAL_1      },
        /* 0x32  50  GM_PERCUSSION_HIGH_TOM           */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_HIGH_TOM            },
        /* 0x33  51  GM_PERCUSSION_RIDE_CYMBAL_1      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_RIDE_CYMBAL_1       },
        /* 0x34  52  GM_PERCUSSION_CHINESE_CYMBAL     */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_CHINESE_CYMBAL      },
        /* 0x35  53  GM_PERCUSSION_RIDE_BELL          */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_RIDE_BELL           },
        /* 0x36  54  GM_PERCUSSION_TAMBOURINE         */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_TAMBOURINE          },
        /* 0x37  55  GM_PERCUSSION_SPLASH_CYMBAL      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_SPLASH_CYMBAL       },
        /* 0x38  56  GM_PERCUSSION_COWBELL            */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_COWBELL             },
        /* 0x39  57  GM_PERCUSSION_CRASH_CYMBAL_2     */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_CRASH_CYMBAL_2      },
        /* 0x3A  58  GM_PERCUSSION_VIBRASLAP          */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_VIBRASLAP           },
        /* 0x3B  59  GM_PERCUSSION_RIDE_CYMBAL_2      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_RIDE_CYMBAL_2       },
        /* 0x3C  60  GM_PERCUSSION_HI_BONGO           */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_HI_BONGO            },
        /* 0x3D  61  GM_PERCUSSION_LOW_BONGO          */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LOW_BONGO           },
        /* 0x3E  62  GM_PERCUSSION_MUTE_HI_CONGA      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_MUTE_HI_CONGA       },
        /* 0x3F  63  GM_PERCUSSION_OPEN_HI_CONGA      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_OPEN_HI_CONGA       },
        /* 0x40  64  GM_PERCUSSION_LOW_CONGA          */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LOW_CONGA           },
        /* 0x41  65  GM_PERCUSSION_HIGH_TIMBALE       */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_HIGH_TIMBALE        },
        /* 0x42  66  GM_PERCUSSION_LOW_TIMBALE        */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LOW_TIMBALE         },
        /* 0x43  67  GM_PERCUSSION_HIGH_AGOGO         */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_HIGH_AGOGO          },
        /* 0x44  68  GM_PERCUSSION_LOW_AGOGO          */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LOW_AGOGO           },
        /* 0x45  69  GM_PERCUSSION_CABASA             */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_CABASA              },
        /* 0x46  70  GM_PERCUSSION_MARACAS            */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_MARACAS             },
        /* 0x47  71  GM_PERCUSSION_SHORT_WHISTLE      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_SHORT_WHISTLE       },
        /* 0x48  72  GM_PERCUSSION_LONG_WHISTLE       */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LONG_WHISTLE        },
        /* 0x49  73  GM_PERCUSSION_SHORT_GUIRO        */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_SHORT_GUIRO         },
        /* 0x4A  74  GM_PERCUSSION_LONG_GUIRO         */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LONG_GUIRO          },
        /* 0x4B  75  GM_PERCUSSION_CLAVES             */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_CLAVES              },
        /* 0x4C  76  GM_PERCUSSION_HI_WOOD_BLOCK      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_HI_WOOD_BLOCK       },
        /* 0x4D  77  GM_PERCUSSION_LOW_WOOD_BLOCK     */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_LOW_WOOD_BLOCK      },
        /* 0x4E  78  GM_PERCUSSION_MUTE_CUICA         */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_MUTE_CUICA          },
        /* 0x4F  79  GM_PERCUSSION_OPEN_CUICA         */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_OPEN_CUICA          },
        /* 0x50  80  GM_PERCUSSION_MUTE_TRIANGLE      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_MUTE_TRIANGLE       },
        /* 0x51  81  GM_PERCUSSION_OPEN_TRIANGLE      */ {  .program = PERCUSSION_PROGRAM,  .note = GM_PERCUSSION_OPEN_TRIANGLE       },
    ...
    .melodic_channel_groups = {
        ...
        0b11001100000000111100110011000000, // 0_
        0b00000011000000000000000000000000, // 1_
        0b00000000000000000000000000000000, // 2_
        0b00000000000011000000000000000000, // 3_
