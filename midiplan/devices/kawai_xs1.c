...
const midiplan_device_t kawai_xs1 = {
    ...
    .max_notes_per_channel_group = { 0, 0, 0, 10 },
    ...
    .melodic_programs = {
        /* 0x00   0  GM_PROGRAM_ACOUSTIC_GRAND_PIANO  */ {  .program = KAWAI_XS1_PROGRAM_PIANO_1,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x01   1  GM_PROGRAM_BRIGHT_ACOUSTIC_PIANO */ {  .program = KAWAI_XS1_PROGRAM_BRIGHT_PIANO,    .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x02   2  GM_PROGRAM_ELECTRIC_GRAND_PIANO  */ {  .program = KAWAI_XS1_PROGRAM_DC_EP,           .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x03   3  GM_PROGRAM_HONKY_TONK_PIANO      */ {  .program = KAWAI_XS1_PROGRAM_NAIL_BOX,        .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x04   4  GM_PROGRAM_ELECTRIC_PIANO_1      */ {  .program = KAWAI_XS1_PROGRAM_WURL_EP,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x05   5  GM_PROGRAM_ELECTRIC_PIANO_2      */ {  .program = KAWAI_XS1_PROGRAM_DC_EP,           .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x06   6  GM_PROGRAM_HARPSICHORD           */ {  .program = KAWAI_XS1_PROGRAM_WATER_DANCE,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x07   7  GM_PROGRAM_CLAVI                 */ {  .program = KAWAI_XS1_PROGRAM_CLAVI,           .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x08   8  GM_PROGRAM_CELESTA               */ {  .program = KAWAI_XS1_PROGRAM_BELLS,           .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x09   9  GM_PROGRAM_GLOCKENSPIEL          */ {  .program = KAWAI_XS1_PROGRAM_MALLET,          .flags = KAWAI_XS1_RANGE_DEFAULT        },
        ...
        /* 0x0C  12  GM_PROGRAM_MARIMBA               */ {  .program = KAWAI_XS1_PROGRAM_XYLOPHONE,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x0D  13  GM_PROGRAM_XYLOPHONE             */ {  .program = KAWAI_XS1_PROGRAM_XYLOPHONE,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x0E  14  GM_PROGRAM_TUBULAR_BELLS         */ {  .program = KAWAI_XS1_PROGRAM_VIBRAPHONE,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x0F  15  GM_PROGRAM_DULCIMER              */ {  .program = KAWAI_XS1_PROGRAM_LUCY,            .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x10  16  GM_PROGRAM_DRAWBAR_ORGAN         */ {  .program = KAWAI_XS1_PROGRAM_E_ORGAN,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x11  17  GM_PROGRAM_PERCUSSIVE_ORGAN      */ {  .program = KAWAI_XS1_PROGRAM_BRASS_VOICE,     .flags = KAWAI_XS1_RANGE_OCTAVE_LOWER   },
        /* 0x12  18  GM_PROGRAM_ROCK_ORGAN            */ {  .program = KAWAI_XS1_PROGRAM_E_ORGAN_2,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x13  19  GM_PROGRAM_CHURCH_ORGAN          */ {  .program = KAWAI_XS1_PROGRAM_CHURCH_ORGAN,    .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x14  20  GM_PROGRAM_REED_ORGAN            */ {  .program = KAWAI_XS1_PROGRAM_BEE_52,          .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x15  21  GM_PROGRAM_ACCORDION             */ {  .program = KAWAI_XS1_PROGRAM_ACCORDION,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        ...
        /* 0x19  25  GM_PROGRAM_ACOUSTIC_GUITAR_STEEL */ {  .program = KAWAI_XS1_PROGRAM_DC_BASS,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x1A  26  GM_PROGRAM_ELECTRIC_GUITAR_JAZZ  */ {  .program = KAWAI_XS1_PROGRAM_STEELY_GTR,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x1B  27  GM_PROGRAM_ELECTRIC_GUITAR_CLEAN */ {  .program = KAWAI_XS1_PROGRAM_DC_BASS,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x1C  28  GM_PROGRAM_ELECTRIC_GUITAR_MUTED */ {  .program = KAWAI_XS1_PROGRAM_PULL_BASS,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x1D  29  GM_PROGRAM_OVERDRIVEN_GUITAR     */ {  .program = KAWAI_XS1_PROGRAM_FUZZ_GT,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x1E  30  GM_PROGRAM_DISTORTION_GUITAR     */ {  .program = KAWAI_XS1_PROGRAM_DIST,            .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x1F  31  GM_PROGRAM_GUITAR_HARMONICS      */ {  .program = KAWAI_XS1_PROGRAM_MUTE_RELEASE,    .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x20  32  GM_PROGRAM_ACOUSTIC_BASS         */ {  .program = KAWAI_XS1_PROGRAM_W_BASS_VIBE,     .flags = KAWAI_XS1_RANGE_LOWER_HALF     },
        /* 0x21  33  GM_PROGRAM_ELECTRIC_BASS_FINGER  */ {  .program = KAWAI_XS1_PROGRAM_E_BASS_CLAVI,    .flags = KAWAI_XS1_RANGE_LOWER_HALF     },
        /* 0x22  34  GM_PROGRAM_ELECTRIC_BASS_PICK    */ {  .program = KAWAI_XS1_PROGRAM_SHARP_BASS,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x23  35  GM_PROGRAM_FRETLESS_BASS         */ {  .program = KAWAI_XS1_PROGRAM_FRETLESS,        .flags = KAWAI_XS1_RANGE_OCTAVE_HIGHER  },
        /* 0x24  36  GM_PROGRAM_SLAP_BASS_1           */ {  .program = KAWAI_XS1_PROGRAM_SYN_BASS_VOICE,  .flags = KAWAI_XS1_RANGE_LOWER_HALF     },
        /* 0x25  37  GM_PROGRAM_SLAP_BASS_2           */ {  .program = KAWAI_XS1_PROGRAM_SLAP_BASS,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x26  38  GM_PROGRAM_SYNTH_BASS_1          */ {  .program = KAWAI_XS1_PROGRAM_E_BASS_CLAVI,    .flags = KAWAI_XS1_RANGE_LOWER_HALF     },
        /* 0x27  39  GM_PROGRAM_SYNTH_BASS_2          */ {  .program = KAWAI_XS1_PROGRAM_WARM_BASS,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x28  40  GM_PROGRAM_VIOLIN                */ {  .program = KAWAI_XS1_PROGRAM_VIOLIN,          .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x29  41  GM_PROGRAM_VIOLA                 */ {  .program = KAWAI_XS1_PROGRAM_VIOLIN,          .flags = KAWAI_XS1_RANGE_OCTAVE_LOWER   },
        /* 0x2A  42  GM_PROGRAM_CELLO                 */ {  .program = KAWAI_XS1_PROGRAM_VIOLIN,          .flags = KAWAI_XS1_RANGE_OCTAVE_LOWER   },
        /* 0x2B  43  GM_PROGRAM_CONTRABASS            */ {  .program = KAWAI_XS1_PROGRAM_CONTRABASS,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x2C  44  GM_PROGRAM_TREMOLO_STRINGS       */ {  .program = KAWAI_XS1_PROGRAM_VIOLIN,          .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x2D  45  GM_PROGRAM_PIZZICATO_STRINGS     */ {  .program = KAWAI_XS1_PROGRAM_BANJO,           .flags = KAWAI_XS1_RANGE_DEFAULT        },
        ...
        /* 0x30  48  GM_PROGRAM_STRING_ENSEMBLE_1     */ {  .program = KAWAI_XS1_PROGRAM_OCT_BRASS,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x31  49  GM_PROGRAM_STRING_ENSEMBLE_2     */ {  .program = KAWAI_XS1_PROGRAM_OCT_BRASS,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x32  50  GM_PROGRAM_SYNTHSTRINGS_1        */ {  .program = KAWAI_XS1_PROGRAM_SAW_LEAD_1,      .flags = KAWAI_XS1_RANGE_OCTAVE_HIGHER  },
        /* 0x33  51  GM_PROGRAM_SYNTHSTRINGS_2        */ {  .program = KAWAI_XS1_PROGRAM_SAW_LEAD_1,      .flags = KAWAI_XS1_RANGE_OCTAVE_HIGHER  },
        /* 0x34  52  GM_PROGRAM_CHOIR_AAHS            */ {  .program = KAWAI_XS1_PROGRAM_NORM_VOICE,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x35  53  GM_PROGRAM_VOICE_OOHS            */ {  .program = KAWAI_XS1_PROGRAM_SE_VOICE,        .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x36  54  GM_PROGRAM_SYNTH_VOICE           */ {  .program = KAWAI_XS1_PROGRAM_CHA_CHA,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x37  55  GM_PROGRAM_ORCHESTRA_HIT         */ {  .program = KAWAI_XS1_PROGRAM_BRASS_VOICE,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x38  56  GM_PROGRAM_TRUMPET               */ {  .program = KAWAI_XS1_PROGRAM_AC_BRASS,        .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x39  57  GM_PROGRAM_TROMBONE              */ {  .program = KAWAI_XS1_PROGRAM_SYN_BRASS,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x3A  58  GM_PROGRAM_TUBA                  */ {  .program = KAWAI_XS1_PROGRAM_OCT_BRASS,       .flags = KAWAI_XS1_RANGE_OCTAVE_LOWER   },
        ...
        /* 0x3D  61  GM_PROGRAM_BRASS_SECTION         */ {  .program = KAWAI_XS1_PROGRAM_BRASS_STRINGS,   .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x3E  62  GM_PROGRAM_SYNTHBRASS_1          */ {  .program = KAWAI_XS1_PROGRAM_BRASS_VOICE,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x3F  63  GM_PROGRAM_SYNTHBRASS_2          */ {  .program = KAWAI_XS1_PROGRAM_PIANO_BRASS_2,   .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x40  64  GM_PROGRAM_SOPRANO_SAX           */ {  .program = KAWAI_XS1_PROGRAM_ALTO,            .flags = KAWAI_XS1_RANGE_OCTAVE_HIGHER  },
        /* 0x41  65  GM_PROGRAM_ALTO_SAX              */ {  .program = KAWAI_XS1_PROGRAM_ALTO,            .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x42  66  GM_PROGRAM_TENOR_SAX             */ {  .program = KAWAI_XS1_PROGRAM_TENOR_SAX,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x43  67  GM_PROGRAM_BARITONE_SAX          */ {  .program = KAWAI_XS1_PROGRAM_TENOR_SAX,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x44  68  GM_PROGRAM_OBOE                  */ {  .program = KAWAI_XS1_PROGRAM_OBOE,            .flags = KAWAI_XS1_RANGE_DEFAULT        },
        ...
        /* 0x48  72  GM_PROGRAM_PICCOLO               */ {  .program = KAWAI_XS1_PROGRAM_PAN_FLUTE,       .flags = KAWAI_XS1_RANGE_OCTAVE_HIGHER  },
        /* 0x49  73  GM_PROGRAM_FLUTE                 */ {  .program = KAWAI_XS1_PROGRAM_PAN_FLUTE,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        ...
        /* 0x4C  76  GM_PROGRAM_BLOWN_BOTTLE          */ {  .program = KAWAI_XS1_PROGRAM_TIN_WHISTLE,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x4D  77  GM_PROGRAM_SHAKUHACHI            */ {  .program = KAWAI_XS1_PROGRAM_PAN_FLUTE,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x4E  78  GM_PROGRAM_WHISTLE               */ {  .program = KAWAI_XS1_PROGRAM_TIN_WHISTLE,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        ...
        /* 0x51  81  GM_PROGRAM_LEAD_2_SAWTOOTH       */ {  .program = KAWAI_XS1_PROGRAM_SAW_LEAD_1,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x52  82  GM_PROGRAM_LEAD_3_CALLIOPE       */ {  .program = KAWAI_XS1_PROGRAM_E_ORGAN,         .flags = KAWAI_XS1_RANGE_OCTAVE_HIGHER  },
        /* 0x53  83  GM_PROGRAM_LEAD_4_CHIFF          */ {  .program = KAWAI_XS1_PROGRAM_PIANO_STRING,    .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x54  84  GM_PROGRAM_LEAD_5_CHARANG        */ {  .program = KAWAI_XS1_PROGRAM_SAW_LEAD_1,      .flags = KAWAI_XS1_RANGE_OCTAVE_HIGHER  },
        /* 0x55  85  GM_PROGRAM_LEAD_6_VOICE          */ {  .program = KAWAI_XS1_PROGRAM_11_CC,           .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x56  86  GM_PROGRAM_LEAD_7_FIFTHS         */ {  .program = KAWAI_XS1_PROGRAM_SAW_LEAD_2,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x57  87  GM_PROGRAM_LEAD_8_BASS_LEAD      */ {  .program = KAWAI_XS1_PROGRAM_E_BASS_CLAVI,    .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x58  88  GM_PROGRAM_PAD_1_NEW_AGE         */ {  .program = KAWAI_XS1_PROGRAM_STEELY_GTR,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x59  89  GM_PROGRAM_PAD_2_WARM            */ {  .program = KAWAI_XS1_PROGRAM_SAW_PAD,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x5A  90  GM_PROGRAM_PAD_3_POLYSYNTH       */ {  .program = KAWAI_XS1_PROGRAM_SQR_LEAD,        .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x5B  91  GM_PROGRAM_PAD_4_CHOIR           */ {  .program = KAWAI_XS1_PROGRAM_SE_VOICE,        .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x5C  92  GM_PROGRAM_PAD_5_BOWED           */ {  .program = KAWAI_XS1_PROGRAM_STRING_VOICE,    .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x5D  93  GM_PROGRAM_PAD_6_METALLIC        */ {  .program = KAWAI_XS1_PROGRAM_SPINETT,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x5E  94  GM_PROGRAM_PAD_7_HALO            */ {  .program = KAWAI_XS1_PROGRAM_WATER_DREAM,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x5F  95  GM_PROGRAM_PAD_8_SWEEP           */ {  .program = KAWAI_XS1_PROGRAM_SPACE_VOX,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x60  96  GM_PROGRAM_FX_1_RAIN             */ {  .program = KAWAI_XS1_PROGRAM_WATER_DREAM,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x61  97  GM_PROGRAM_FX_2_SOUNDTRACK       */ {  .program = KAWAI_XS1_PROGRAM_BRASS_VOICE,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x62  98  GM_PROGRAM_FX_3_CRYSTAL          */ {  .program = KAWAI_XS1_PROGRAM_SPIELUHR,        .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x63  99  GM_PROGRAM_FX_4_ATMOSPHERE       */ {  .program = KAWAI_XS1_PROGRAM_STRING_VOICE,    .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x64 100  GM_PROGRAM_FX_5_BRIGHTNESS       */ {  .program = KAWAI_XS1_PROGRAM_STEEL_DRUM,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x65 101  GM_PROGRAM_FX_6_GOBLINS          */ {  .program = KAWAI_XS1_PROGRAM_DIST,            .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x66 102  GM_PROGRAM_FX_7_ECHOES           */ {  .program = KAWAI_XS1_PROGRAM_OCT_STRINGS,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x67 103  GM_PROGRAM_FX_8_SCI_FI           */ {  .program = KAWAI_XS1_PROGRAM_SPACE_VOX,       .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x68 104  GM_PROGRAM_SITAR                 */ {  .program = KAWAI_XS1_PROGRAM_SITAR,           .flags = KAWAI_XS1_RANGE_DEFAULT        },
        ...
        /* 0x6E 110  GM_PROGRAM_FIDDLE                */ {  .program = KAWAI_XS1_PROGRAM_VIOLIN,          .flags = KAWAI_XS1_RANGE_DEFAULT        },
        ...
        /* 0x71 113  GM_PROGRAM_AGOGO                 */ {  .program = KAWAI_XS1_PROGRAM_TIN_DRUM,        .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x72 114  GM_PROGRAM_STEEL_DRUMS           */ {  .program = KAWAI_XS1_PROGRAM_STEEL_DRUM,      .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x73 115  GM_PROGRAM_WOODBLOCK             */ {  .program = KAWAI_XS1_PROGRAM_COWBELL,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
        ...
        /* 0x77 119  GM_PROGRAM_REVERSE_CYMBAL        */ {  .program = KAWAI_XS1_PROGRAM_SYNTH_SE,        .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x78 120  GM_PROGRAM_GUITAR_FRET_NOISE     */ {  .program = KAWAI_XS1_PROGRAM_SEQ_PLUCK_1,     .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x79 121  GM_PROGRAM_BREATH_NOISE          */ {  .program = KAWAI_XS1_PROGRAM_SE_VOICE,        .flags = KAWAI_XS1_RANGE_DEFAULT        },
        /* 0x7A 122  GM_PROGRAM_SEASHORE              */ {  .program = KAWAI_XS1_PROGRAM_NORM_VOICE,      .flags = KAWAI_XS1_RANGE_OCTAVE_LOWER   },
        /* 0x7B 123  GM_PROGRAM_BIRD_TWEET            */ {  .program = KAWAI_XS1_PROGRAM_LIPS,            .flags = KAWAI_XS1_RANGE_OCTAVE_HIGHER  },
        /* 0x7C 124  GM_PROGRAM_TELEPHONE_RING        */ {  .program = KAWAI_XS1_PROGRAM_SE_BELL,         .flags = KAWAI_XS1_RANGE_DEFAULT        },
    ...
    .program_change_sequence = (const uint8_t[]) {
        ...
        MIDI_MESSAGE_DELAY, 0x00, 0x19, /* 25 ms */
